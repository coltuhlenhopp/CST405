...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_VarDeclList = 14,               /* VarDeclList  */
  YYSYMBOL_VarDecl = 15,                   /* VarDecl  */
...
{
       0,    49,    49,    59,    65,    74,    84,    94,   100,   110,
     131,   142,   150,   159,   168
};
#endif
...
static const char *const yytname[] =
{
  ...
  "SEMICOLON", "EQ", "PLUS", "NUMBER", "WRITE", "'('", "')'", "$accept",
  "Program", "VarDeclList", "VarDecl", "StmtList", "Stmt", "Expr", YY_NULLPTR
};
...
{
       8,    10,    15,    -2,     8,     0,   -17,    11,    12,   -17,
      -2,   -17,   -17,   -17,    -4,    13,   -17,   -17,   -17,    -4,
       5,   -17,     2,   -17,    -4,   -17,   -17
};
...
{
      17,    12,     7,    22,    18,    13,    19,     8,    26,    24,
      23,     1,    24,    25,     5,     6,    15,    14,    21,    16,
      11
};

static const yytype_int8 yycheck[] =
{
       4,     1,     4,    19,     8,     5,    10,     9,    24,     7,
       5,     3,     7,    11,     4,     0,     4,     6,     5,    10,
       4
};
...
{
       0,     3,    13,    14,    15,     4,     0,     4,     9,    16,
      17,    14,     1,     5,     6,     4,    16,     4,     8,    10,
      18,     5,    18,     5,     7,    11,    18
};
...
#line 59 "mini_parser1.y"
        ...
        (yyval.ast)->varDeclList.varDeclList = (yyvsp[0].ast); // Recursively build the list
    }
#line 1119 "mini_parser1.tab.c"
    break;

  case 4: /* VarDeclList: VarDecl  */
#line 65 "mini_parser1.y"
          {
    printf("PARSER: Recognized final variable declaration\n");
    (yyval.ast) = createNode(NodeType_VarDeclList);
    (yyval.ast)->varDeclList.varDecl = (yyvsp[0].ast);
    (yyval.ast)->varDeclList.varDeclList = NULL; // End of the declaration list
}
#line 1130 "mini_parser1.tab.c"
    break;

  case 5: /* VarDecl: TYPE ID SEMICOLON  */
#line 74 "mini_parser1.y"
                           { 
    printf("PARSER: Recognized variable declaration: %s\n", (yyvsp[-1].string));
    if (!addSymbol(symbolTable, (yyvsp[-1].string), (yyvsp[-2].string))) {
...
#line 1145 "mini_parser1.tab.c"
    break;

  case 6: /* VarDecl: TYPE ID error  */
#line 84 "mini_parser1.y"
                {
...
#line 94 "mini_parser1.y"
        ...
        (yyval.ast)->stmtList.stmtList = (yyvsp[0].ast); // Recursively build the list
    }
#line 1168 "mini_parser1.tab.c"
    break;

  case 8: /* StmtList: Stmt  */
#line 100 "mini_parser1.y"
       {
    printf("PARSER: Recognized final statement\n");
    (yyval.ast) = createNode(NodeType_StmtList);
    (yyval.ast)->stmtList.stmt = (yyvsp[0].ast);
    (yyval.ast)->stmtList.stmtList = NULL; // End of the statement list
}
#line 1179 "mini_parser1.tab.c"
    break;

  case 9: /* Stmt: ID EQ Expr SEMICOLON  */
#line 110 "mini_parser1.y"
                           {
    printf("PARSER: Recognized assignment statement\n");
    (yyval.ast) = createNode(NodeType_Stmt);
    (yyval.ast)->stmt.varName = strdup((yyvsp[-3].string));
    (yyval.ast)->stmt.operator = strdup("="); 
    (yyval.ast)->stmt.expr = (yyvsp[-1].ast); 

    // Evaluate the expression to get its value
    int value = evaluateExpression((yyvsp[-1].ast)); // Ensure this function is implemented correctly
...
#line 1204 "mini_parser1.tab.c"
    break;

  case 10: /* Stmt: WRITE ID SEMICOLON  */
#line 131 "mini_parser1.y"
                     {
    printf("PARSER: Recognized write statement\n"); 
    (yyval.ast) = createNode(NodeType_Stmt);
    (yyval.ast)->stmt.varName = strdup((yyvsp[-1].string));
    (yyval.ast)->stmt.operator = strdup("WRITE");
    (yyval.ast)->stmt.expr = NULL;
    //generateTAC("WRITE", $$->stmt.operator, NULL, NULL);
}
#line 1217 "mini_parser1.tab.c"
    break;

  case 11: /* Expr: Expr PLUS Expr  */
#line 142 "mini_parser1.y"
                     { 
    ...
    (yyval.ast)->expr.varName = NULL;
}
#line 1230 "mini_parser1.tab.c"
    break;

  case 12: /* Expr: ID  */
#line 150 "mini_parser1.y"
     { 
    printf("PARSER: Recognized variable: %s\n", (yyvsp[0].string));
    (yyval.ast) = createNode(NodeType_Expr);
    (yyval.ast)->expr.operator = NULL;
    (yyval.ast)->expr.left = NULL;
    (yyval.ast)->expr.right = NULL;
    (yyval.ast)->expr.varName = strdup((yyvsp[0].string));
    (yyval.ast)->expr.number = 0;
}
#line 1244 "mini_parser1.tab.c"
    break;

  case 13: /* Expr: NUMBER  */
#line 159 "mini_parser1.y"
         { 
    ...
    (yyval.ast)->expr.right = NULL;
    (yyval.ast)->expr.varName = NULL;
    (yyval.ast)->expr.number = (yyvsp[0].number);
}
#line 1258 "mini_parser1.tab.c"
    break;

  case 14: /* Expr: '(' Expr ')'  */
#line 168 "mini_parser1.y"
               {
    printf("PARSER: Recognized expression in parentheses\n");
    (yyval.ast) = (yyvsp[-1].ast); // Pass the expression inside parentheses up the tree
}
#line 1267 "mini_parser1.tab.c"
    break;


#line 1271 "mini_parser1.tab.c"
