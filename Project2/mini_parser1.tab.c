...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_UNRECOGNIZED = 10,              /* UNRECOGNIZED  */
  YYSYMBOL_YYACCEPT = 11,                  /* $accept  */
  YYSYMBOL_Program = 12,                   /* Program  */
  YYSYMBOL_VarDeclList = 13,               /* VarDeclList  */
...
{
       0,    64,    64,    78,    81,    95,   114,   122,   125,   139,
     164,   169,   188,   193,   201,   212,   229
};
#endif
...
static const char *const yytname[] =
{
  ...
  "SEMICOLON", "EQ", "PLUS", "NUMBER", "WRITE", "UNRECOGNIZED", "$accept",
...
{
       3,     0,     0,     7,     3,     6,     1,     0,     0,    13,
       2,     7,     4,     5,     0,    12,     8,    15,    16,    10,
      11,     9,     0,    14
};
...
{
       7,     1,    21,    17,    22,     8,     9,    18,     5,     6,
      13,    15,    14,    20,    12,    23,     0,     0,     0,     0,
       0,     0,    16
};

static const yytype_int8 yycheck[] =
{
       4,     3,     5,     4,     7,     9,    10,     8,     4,     0,
       5,     4,     6,     5,     4,    22,    -1,    -1,    -1,    -1,
      -1,    -1,    11
};
...
{
       0,     3,    12,    13,    14,     4,     0,     4,     9,    10,
      15,    16,    13,     5,     6,     4,    15,     4,     8,    17,
       5,     5,     7,    17
};
                       ...
                       yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep)
{
  ...
  switch (yykind)
    {
    case YYSYMBOL_ID: /* ID  */
#line 56 "mini_parser1.y"
         { fprintf(yyoutput, "%s", ((*yyvaluep).string)); }
#line 731 "mini_parser1.tab.c"
        break;
...
#line 64 "mini_parser1.y"
        ...
        (yyval.ast)->type = NodeType_Program;
...
#line 1132 "mini_parser1.tab.c"
    break;

  case 3: /* VarDeclList: %empty  */
#line 78 "mini_parser1.y"
            {
...
#line 1156 "mini_parser1.tab.c"
    break;

  case 5: /* VarDecl: TYPE ID SEMICOLON  */
#line 95 "mini_parser1.y"
                      {
        if (lookupSymbol(symTab, (yyvsp[-1].string)) != NULL) {
        ...
        addSymbol(symTab, (yyvsp[-1].string), (yyvsp[-2].string), INT_MIN);
...
#line 1213 "mini_parser1.tab.c"
    break;

  case 9: /* Stmt: ID EQ Expr SEMICOLON  */
#line 139 "mini_parser1.y"
                         {
        ...
        sym->intValue = evaluateExpr((yyvsp[-1].ast), symTab);
        char* exprResult = genExprTAC((yyvsp[-1].ast), symTab);   //===============================================
        ...
        (yyval.ast)->assignStmt.operators = (yyvsp[-2].operators);
        (yyval.ast)->assignStmt.expr = (yyvsp[-1].ast);

    }
#line 1242 "mini_parser1.tab.c"
    break;

  case 10: /* Stmt: ID EQ Expr  */
#line 164 "mini_parser1.y"
                  { //-------------------------------------------------------------------------
        fprintf(stderr, "Need a semicolon silly goose at line %d.\n", yylineno - 1);
        parserErrorFlag = 1;
        YYABORT;
    }
#line 1252 "mini_parser1.tab.c"
    break;

  case 11: /* Stmt: WRITE ID SEMICOLON  */
#line 169 "mini_parser1.y"
                         {
        ...
        genTAC("WRITE", (yyval.ast)->writeStmt.id, NULL, NULL);
    }
#line 1275 "mini_parser1.tab.c"
    break;

  case 12: /* Stmt: WRITE ID  */
#line 188 "mini_parser1.y"
                {
        fprintf(stderr, "Need a semicolon at line %d.\n", yylineno - 1);
        parserErrorFlag = 1;
        YYABORT;
    }
#line 1285 "mini_parser1.tab.c"
    break;

  case 13: /* Stmt: UNRECOGNIZED  */
#line 193 "mini_parser1.y"
                   {
        fprintf(stderr, "Something weird at line %d.\n", yylineno);
        parserErrorFlag = 1;
        YYABORT;
    }
#line 1295 "mini_parser1.tab.c"
    break;

  case 14: /* Expr: Expr PLUS Expr  */
#line 201 "mini_parser1.y"
                   {
        (yyval.ast) = malloc(sizeof(ASTNode));
        if ((yyval.ast) == NULL) {
        ...
        (yyval.ast)->expr.operators = (yyvsp[-1].operators);
    }
#line 1311 "mini_parser1.tab.c"
    break;

  case 15: /* Expr: ID  */
#line 212 "mini_parser1.y"
         {
...
#line 1333 "mini_parser1.tab.c"
    break;

  case 16: /* Expr: NUMBER  */
#line 229 "mini_parser1.y"
             {
        (yyval.ast) = malloc(sizeof(ASTNode));
        if ((yyval.ast) == NULL) {
...
#line 1348 "mini_parser1.tab.c"
    break;


#line 1352 "mini_parser1.tab.c"
