...
// Makes it easier in the AST to print a string
const char* typeToString(NodeType type) {
    switch (type) {
        ...
        case NodeType_SimpleExpr: return "Simple Expression";
...
void freeAST(ASTNode* node) {
    ...
    switch (node->type) {
        ...
        case NodeType_VarDecl:
            ...
            break;
        case NodeType_SimpleExpr:
            // No dynamic memory to free in SimpleExpr
            break;
        case NodeType_WriteStmt:
...
ASTNode* createNode(NodeType type) {
    ...
    if (newNode == NULL) {
        ...
        fprintf(stderr, "Memory Failure when making new node. Wamp wamp waaaaa\n");
        return NULL;
    }
